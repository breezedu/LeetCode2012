 ...
 *
 */
public class MultiplyStringsNAIVE {
	...
	private static String multiplyStrings(String num1, String num2) {
		...
		for(int i=0; i<Len2; i++){
			int curr = num2.charAt(i)-'0'; //Integer.parseInt(num2.substring(i, i+1));
	...
	private static String addTwoString(String str1, String str2) {
		...
		int plus = 0;
		for(int i=0; i<min; i++){
			int n1 = str1.charAt(Len1-1-i)-'0'; // Integer.parseInt(str1.substring(Len1-1-i, Len1-i));
			int n2 = str2.charAt(Len2-1-i)-'0'; //Integer.parseInt(str2.substring(Len2-1-i, Len2-i));
		...
		if(Len1>Len2){
			...
			for(int i=Len1-Len2-1; i>=0; i--){
				int n1 = str1.charAt(i)-'0'; //Integer.parseInt(str1.substring(i, i+1));
				int tempSum = n1 + plus;
				retStr = tempSum%10 + retStr;
				plus = tempSum/10;
			}//end for i>=0 loop;
			...
			for(int i=Len2-Len1-1; i>=0; i--){
				int n2 = str2.charAt(i)-'0'; //Integer.parseInt(str2.substring(i, i+1));
				int tempSum = n2 + plus;
				retStr = tempSum%10 + retStr;
				plus = tempSum/10;				
			}//end for i>=0 loop;
